...
faq:
  - question: "À partir de quel patrimoine l'exit tax s'applique-t-elle en 2026 ?"
    reponse: "L'exit tax s'applique si vous détenez des droits sociaux d'une valeur globale > 800 000 € OU si vous détenez plus de 50% du capital d'une société. Attention : une réforme PLF 2026 propose de relever ce seuil à 1,3 M€. Vérifiez l'état d'avancement de cette réforme avant votre départ."
  ...
  - question: "Que se passe-t-il si je reviens en France dans les 5 ans (ou 15 ans avec la réforme) ?"
    reponse: "Sous le régime actuel, si vous revenez en France dans un délai de 5 ans après votre départ, l'exit tax est automatiquement annulée. Le PLF 2026 prévoit de porter ce délai à 15 ans, ce qui constituerait une contrainte très significative pour les entrepreneurs. Si cette réforme est adoptée définitivement, partir en 2026 avant son entrée en vigueur devient un enjeu de planification."
  - question: "Comment se calcule la valeur des titres pour l'exit tax ?"
    reponse: "La valeur des titres est calculée à la date du transfert de domicile fiscal — valeur de marché pour les actions cotées, valeur vénale pour les titres non cotés. L'administration peut remettre en cause la valorisation des titres non cotés si elle estime qu'elle est sous-évaluée."
  - question: "Qu'est-ce que la réforme de l'exit tax dans le PLF 2026 ?"
    reponse: "Le Projet de Loi de Finances 2026 prévoit deux modifications majeures de l'exit tax : (1) relèvement du seuil d'application de 800 000 € à 1,3 M€, et (2) allongement du délai d'extinction de 5 à 15 ans. Ces mesures n'étaient pas encore définitivement adoptées en mars 2026 — vérifiez l'état du texte au moment de votre lecture."
---
...
## ⚠️ Réforme PLF 2026 : ce qui pourrait changer

Le Projet de Loi de Finances 2026 contient des **amendements significatifs sur l'exit tax**, dont certains ont été adoptés en première lecture à l'Assemblée Nationale en novembre 2025 :

### 1. Relèvement du seuil d'application : 800 000 € → 1,3 M€

Le seuil de déclenchement passerait de 800 000 € à **1,3 M€** de valeur de portefeuille. Cette mesure réduirait le nombre de contribuables concernés et alignerait la France sur les standards européens.

**Impact :** si votre portefeuille est entre 800 000 € et 1,3 M€, attendez que la réforme soit définitivement adoptée — vous pourriez partir sans exit tax.

### 2. Allongement du délai d'extinction : 5 ans → 15 ans

C'est la modification la **plus contraignante** : le délai après lequel l'exit tax s'éteint passerait de 5 ans à **15 ans**. Cette mesure vise à décourager les départs suivis d'un retour rapide en France après la vente des titres.

**Impact concret :** un entrepreneur qui part à Dubaï, vend sa société après 6 ans, et rentre en France après 10 ans devrait toujours l'exit tax sous le nouveau régime — ce qui n'est pas le cas aujourd'hui.

### 3. État d'avancement à mars 2026

Ces amendements ont été adoptés par l'Assemblée Nationale mais le processus législatif n'était pas achevé en mars 2026. Le texte final peut différer. **Vérifiez l'état définitif du PLF 2026 avant toute décision** auprès d'un fiscaliste ou sur legifrance.gouv.fr.

> **Conseil stratégique :** si vous envisagez de partir prochainement et que votre patrimoine en titres est supérieur à 800 000 €, consulter un fiscaliste **avant** la publication de la loi définitive est essentiel. Le calendrier de votre départ peut représenter des centaines de milliers d'euros d'écart.
